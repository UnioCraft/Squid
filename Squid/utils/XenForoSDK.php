...
class XenForoSDK
{
    public function __construct()
    {
        ...
        require_once(__XENFORO_ROOT__ . '/library/XenForo/Autoloader.php');
        XenForo_Autoloader::getInstance()->setupAutoloader(__XENFORO_ROOT__ . '/library');
        XenForo_Application::initialize(__XENFORO_ROOT__ . '/library', __XENFORO_ROOT__ . '/');
